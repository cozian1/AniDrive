...
//     static serverName = 'RapidCloud';
//     static sources: IVideo[] = [];
  
//     static fallbackKey = 'c1d17096f2ca11b7';
//     static host = 'https://rapid-cloud.co';
  
//     static extract = async (videoUrl): Promise<{ sources: IVideo[] } & { subtitles: ISubtitle[] }> => {
...
//     static captcha = async (url: string, key: string): Promise<string> => {
